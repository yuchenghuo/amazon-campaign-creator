...
class AutoDisaggregation extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
      ...
      negativeKeywordsExact: null,
      negativeKeywordsPhrase: null,
      negativeAsinTargets: null,
      defaultBid: null,
      bidAdjustment: null,
  ...
  render() {
    ...
    return (
      <div>
        <button className={"campaign-theme"} onClick={this.handleClickOpen}>Auto Disaggregation</button>
        <Dialog open={this.state.open} onClose={this.handleClose}>
          <DialogTitle>
            <Typography style={{fontFamily: 'Anek Latin, sans-serif', fontSize: 24}}>
              Auto Disaggregation Campaign
            </Typography>
          </DialogTitle>
          <DialogContent style={{ marginBottom: 0 }}>
            <DialogContentText>
              <p style={{fontFamily: 'Anek Latin, sans-serif', fontSize: 18, fontWeight: 900, marginBottom: 2}}>
                To create a auto disaggregation campaign, please fill out the following form.
              </p>
            </DialogContentText>
            <ThemeProvider theme={theme}>
              ...
              <TextField
                margin="dense"
                label="Negative Keywords Exact"
                type="text"
                onChange={(e) => this.setState({negativeKeywordsExact: e.target.value})}
                fullWidth
                variant="outlined"
                inputProps={{ style: { fontFamily: 'Anek Latin, sans-serif', fontSize: 18 } }}
                InputLabelProps={{ sx: { fontFamily: 'Anek Latin, sans-serif', fontSize: 18 } }}
              ...
              <TextField
                ...
                type="text"
                onChange={(e) => this.setState({negativeKeywordsPhrase: e.target.value})}
                fullWidth
                variant="outlined"
                inputProps={{ style: { fontFamily: 'Anek Latin, sans-serif', fontSize: 18 } }}
                InputLabelProps={{ sx: { fontFamily: 'Anek Latin, sans-serif', fontSize: 18 } }}
              ...
              <TextField
                margin="dense"
                label="Negative ASIN Targets"
                type="text"
                onChange={(e) => this.setState({negativeAsinTargets: e.target.value})}
                fullWidth
                variant="outlined"
                inputProps={{ style: { fontFamily: 'Anek Latin, sans-serif', fontSize: 18 } }}
                InputLabelProps={{ sx: { fontFamily: 'Anek Latin, sans-serif', fontSize: 18 } }}
