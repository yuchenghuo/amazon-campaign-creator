...
class SingleProduct extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <button className={"campaign-theme"} onClick={this.handleClickOpen}>Single Product</button>
          ...
          <DialogContent style={{ marginBottom: 0 }}>
            <DialogContentText>
              <p style={{fontFamily: 'Anek Latin, sans-serif', fontSize: 18, fontWeight: 900, marginBottom: 2}}>
                To create a single product campaign, please fill out the following form.
              </p>
            </DialogContentText>
            <ThemeProvider theme={theme}>
              ...
              <TextField
                ...
                label="ASIN Targets"
                type="text"
                onChange={(e) => this.setState({asinTargets: e.target.value})}
                fullWidth
                variant="outlined"
                inputProps={{ style: { fontFamily: 'Anek Latin, sans-serif', fontSize: 18 } }}
                InputLabelProps={{ sx: { fontFamily: 'Anek Latin, sans-serif', fontSize: 18 } }}
